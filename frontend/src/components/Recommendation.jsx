    ...
    const getRecommendedPost = async () => {
      try {
        const response = await axios.get(
          ...
          }/api/article/recommend?articleId=${id}&tags=${tags}`
        );
  ...
  return (
    ...
    <div className="max-w-4xl mx-auto p-4 sm:p-10 bg-white mt-10 rounded-md">
      ...
      {recommendPost?.length > 0 ? (
            ...
            <Link to={`/post/${post.id}`}>
              ...
              >
                ...
                <div className="px-6 py-3 flex flex-row items-center justify-between bg-gray-100">
                  ...
                  >
                    <span className="ml-1">{useFormate(post?.createdAtDate)}</span>
                  </span>
                  ...
                  <span
                    ...
                    className="py-1 text-xs font-regular text-gray-900 mr-1 flex flex-row items-center"
                  >
                    <span className="ml-1">{post?.commentsCount} Comments</span>
                  </span>
                </div>
              </div>
            </Link>
        ...
        <div className="flex w-full align-middle items-center justify-center">
